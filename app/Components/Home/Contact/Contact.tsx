      ...
      <div className="w-[90%] md:w-[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
       ...
       <div>
          ...
          <p className="text-gray-400 mt-6 text-base sm:text-lg">
             Reach out to me today and let's discuss how i ca help you achieve your goals.
          </p>
          {/* Info details */}
          <div className='mt-7'>
            <div className='flex items-center space-x-3 mb-4'>
              <BiPhone className='w-9 h-9 text-cyan-300'/>     
              <p className="text-xl font-bold text-gray-400 hover:text-cyan-300 cursor-pointer transition-all duration-100">
                +9843582345
              </p>
            </div>
            <div className='flex items-center space-x-3 mb-4'>
          ...
          <div className='flex items-center mt-8 space-x-3'>
            ...
            className="md:p-10 p-5 bg-[#131332] rounded-lg">
              ...
              <textarea 
                  ...
                  className="px-4 py-3.5 mt-6 bg-[#363659] text-white outline-none rounded-md  w-full h-[10rem] resize-none placeholder:text-white/70"
              ></textarea> 
